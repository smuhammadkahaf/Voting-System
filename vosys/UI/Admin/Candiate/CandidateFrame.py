...
class CandidateFrame(tk.Frame):
    def __init__(self, parent,id):
        ...
        title_label = Common.new_label(title, "Candiates", 30)
        title_label.pack(side="top", pady=10)

        back_button = Common.new_button(back_button_frame, "Back",self.back_button_clicked)
        back_button.pack(side="left", padx=20)

        new_candidate_button_frame = tk.Frame(title, bg="#252525")
        new_candidate_button_frame.pack(fill="x", pady=(0, 10))

        candidate_button = Common.new_button(back_button_frame, "Candidates")
        candidate_button.pack(side="right", padx=20)
    ...
    def back_button_clicked(self):
        ...
        UpdateElectionFrame(self.parent,self.id)